...
export function AdminMemberUpdates({ users }: { users: Profile[] }) {
  ...
  return <div className="card p-5">
    <div className="flex items-start gap-3">
      ...
      <div><h2 className="font-display text-lg font-bold text-ink-900">Send a member update</h2><p className="mt-1 text-sm text-ink-500">Send an operational announcement to the Updates page and, optionally, confirmed email addresses.</p></div>
    </div>
    <div className="mt-5 grid gap-4">
      ...
      <div className="rounded-xl border border-ink-200 bg-ink-50 p-4">
        ...
        <p className="mt-1 text-xs text-ink-500">All {eligible.length} selected members will receive it on their Updates page. Emails are titled “{settings.site_name} Updates” and link directly to the update.</p>
