...
export function RoadHandoff() {
  return <div className="road-handoff mx-auto mt-2 max-w-5xl overflow-hidden" aria-hidden="true">
    <svg viewBox="0 0 900 40" className="block w-full" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M20 28H880" stroke="currentColor" strokeOpacity=".2" strokeWidth="1" strokeDasharray="5 5" />
      ...
      <g className="handoff-key" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
        <circle r="4" fill="var(--handoff-person-fill)" /><path d="M4 0H15M11 0V4M15 0V3" />
      </g>
    </svg>
  </div>;
}
