...
export function ProfileCompletionChecklist({profile}:{profile:Profile}){
 ...
 const nextStep=!photoComplete?'profile photo':profile.role==='driver'&&(!aboutComplete||!driverDetailsComplete)?'profile details':profile.role==='driver'&&!historyComplete?'platform history':'remaining profile information';
