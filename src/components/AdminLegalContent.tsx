...
export function AdminLegalContent() {
  ...
  return <div className="space-y-4">
    <div className="card p-5">
      ...
      <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-5 text-amber-900">Publishing creates a new dated version and preserves previous versions. Review legal changes carefully. New registrations accept the latest Terms version; existing acceptance records are not rewritten.</div>
    </div>
