export const SITE_THEMES = [
  ...
  { id: 'midnight-cyan', name: 'Midnight & Cyan', description: 'Professional dark navy balanced with a crisp cyan action.', swatches: ['#0f172a', '#13d0ff', '#f0fbff'], kind: 'combination' },
  { id: 'navy-gold', name: 'Navy & Gold', description: 'Executive navy with a restrained premium gold accent.', swatches: ['#172554', '#d4a72c', '#fffbeb'], kind: 'combination' },
  { id: 'charcoal-coral', name: 'Charcoal & Coral', description: 'Confident charcoal softened by a warm coral action.', swatches: ['#1f2937', '#f97360', '#fff7f5'], kind: 'combination' },
  { id: 'forest-amber', name: 'Forest & Amber', description: 'Trustworthy forest green with a clear amber action.', swatches: ['#143d2b', '#f59e0b', '#fffbeb'], kind: 'combination' },
  { id: 'plum-rose', name: 'Plum & Rose', description: 'Elegant deep plum paired with a modern rose accent.', swatches: ['#3b164e', '#e85d8e', '#fff1f6'], kind: 'combination' },
  { id: 'slate-teal', name: 'Slate & Teal', description: 'Business-like slate with a clean mobility teal.', swatches: ['#243447', '#14b8a6', '#f0fdfa'], kind: 'combination' },
