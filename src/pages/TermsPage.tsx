  ...
  return (
    <div className="container-content py-12 prose max-w-3xl">
      ...
      <div className="mt-6 space-y-4 text-sm text-ink-700">
        ...
        <p>You must provide accurate information and verify your identity. You are responsible for keeping your PIN secure.</p>
        <h2 className="font-display text-lg font-bold text-ink-900">2. Listings & applications</h2>
        <p>Owners must disclose known vehicle issues and accurate insurance information. Drivers must provide valid documents.</p>
