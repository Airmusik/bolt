...
function AboutFields({ profileForm, setProfileForm }: { profileForm: DriverAboutForm; setProfileForm: (value: DriverAboutForm) => void }) {
  return <Section title="About you" desc="This information is required before your driver profile can appear publicly.">
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <Field label="Residential area" required><PlaceAutocomplete requireSpecificArea ariaLabel="Residential area" typingHint="Choose the neighborhood or town where you live, not your workplace." value={profileForm.location} onChange={(location) => setProfileForm({ ...profileForm, location })} placeholder="e.g. Ongata Rongai" required /></Field>
