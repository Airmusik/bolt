        ...
        <form onSubmit={handleSubmit} className="auth-card" aria-busy={loading}>
          ...
          <div role="group" aria-labelledby="register-about" className="mt-6 border-t border-ink-100 pt-5">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <p id="register-phone-hint" hidden={!phone.trim()} className="auth-hint">Your active Kenyan mobile number.</p>
              </div>
              <div>
                ...
                <p id="register-email-hint" hidden={!email.trim()} className="auth-hint">{completingGoogle ? 'From your Google account. Not shown publicly.' : 'For sign-in and password recovery. Not shown publicly.'}</p>
              </div>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
              ...
              <p id="register-languages-hint" hidden={!languages.trim()} className="auth-hint">At least two languages you speak, separated by commas.</p>
            </div>
          </div>
          ...
          {!completingGoogle && <div role="group" aria-labelledby="register-security" className="mt-6 border-t border-ink-100 pt-5">
            ...
            <div>
              ...
              <p id="register-password-hint" hidden={!pin.length} className="auth-hint">At least 10 characters, including uppercase, lowercase, and a number.</p>
            </div>
