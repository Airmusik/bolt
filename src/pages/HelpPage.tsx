...
const getFaqs = (siteName: string) => [
  ...
  { q: 'Why can’t I connect or change my driver availability?', a: 'Drivers need at least one approved recent platform-history proof. Submit your activity history in Onboarding, or wait for admin approval if you have already uploaded it. Existing chat history remains accessible.' },
  { q: 'How many cars can I list?', a: 'Owners can list 3 cars by default, including pending listings. Contact support to request a higher allowance. An admin can approve extra capacity for your account.' },
  { q: 'How do paid promotions work?', a: 'When enabled, open Promotions from your account menu. Get a quote, follow its payment instructions, and submit the transaction reference. Admin checks receipt before activating Sponsored placement. Promotions have an end date, respect search filters, and do not guarantee connections or replace listing or platform-history approval.' },
  ...
  { q: 'How does the chat work?', a: 'A chat opens after a connection is accepted. Ending the connection makes messaging read-only, but both members keep access to the complete history for safety and dispute resolution. Reconnecting with the same member continues in the same organized history. An administrator can join when support is needed. Private image sharing is available inside active chats; other file types are disabled.' },
