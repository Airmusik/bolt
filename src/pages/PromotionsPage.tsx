...
export function PromotionsPage() {
  ...
  return <div className="container-content max-w-4xl space-y-5 py-6">
    ...
    <header><p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-brand-700"><Megaphone className="h-4 w-4" />Optional paid promotion</p><h1 className="mt-2 font-display text-2xl font-bold text-ink-900 sm:text-3xl">Get more visibility</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-ink-600">{profile?.role === 'owner' ? 'Promote a car so it appears ahead of standard listings in matching searches.' : 'Promote your driver profile so it appears ahead of standard profiles in matching searches.'} It is labelled Sponsored. Connections and enquiries are not guaranteed.</p></header>
