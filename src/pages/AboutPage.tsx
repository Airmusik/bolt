  ...
  return (
    <div className="container-content py-12">
      ...
      <p className="mt-3 max-w-2xl text-ink-600">
        ...
        so both parties can make informed decisions. {settings.site_name} does not process rental payments between members — it simply brings the right people together.
      </p>
